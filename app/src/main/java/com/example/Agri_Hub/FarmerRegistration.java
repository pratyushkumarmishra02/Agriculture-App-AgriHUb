...
public class FarmerRegistration extends LanguageBaseActivity {
...
//        }
        ...
        Toast.makeText(FarmerRegistration.this, "You can register now", Toast.LENGTH_LONG).show();
        ...
        Dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new DatePickerDialog(FarmerRegistration.this, new DatePickerDialog.OnDateSetListener() {
        ...
        rbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(textflname)) {
                    ...
                    Toast.makeText(FarmerRegistration.this, "Please select your gender", Toast.LENGTH_LONG).show();
        ...
        lgn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FarmerRegistration.this, FarmerLoginActivity.class);
    ...
    private void registerUser(String textflname, String texteml, String textDob, String textph_number, String textpwd, String textGender) {
        ...
        auth.createUserWithEmailAndPassword(texteml, textpwd).addOnCompleteListener(FarmerRegistration.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    String farmerId = firebaseuser.getUid();
                    ...
                    SharedData.getInstance().setFarmerId(farmerId);

                    FirebaseFirestore firestore = FirebaseFirestore.getInstance();
                    firestore.collection("Farmers").document(firebaseuser.getUid()).set(userData).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                firebaseuser.sendEmailVerification();
                                Toast.makeText(FarmerRegistration.this, "User registered successfully. Please verify your email", Toast.LENGTH_LONG).show();
                                Intent intent= new Intent(FarmerRegistration.this, FarmerLoginActivity.class);
                                startActivity(intent);
                                finish();
                            } else {
                                Toast.makeText(FarmerRegistration.this, "User registration failed. Please try again", Toast.LENGTH_LONG).show();
                            }
                    ...
                    try {
                        ...
                        Toast.makeText(FarmerRegistration.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                    pb.setVisibility(View.GONE);
                }
            }
