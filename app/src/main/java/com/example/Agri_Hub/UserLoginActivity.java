...
public class UserLoginActivity extends LanguageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forgetPasswordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UserLoginActivity.this, ForgotPasswordForUserActivity.class));
            }
        });
    }
        ...
        if (userRole != null) {
            ...
            db.collection("Roles").document(userId)
                    ...
                    .addOnSuccessListener(aVoid -> {
                       // Toast.makeText(UserLoginActivity.this, "User role saved!", Toast.LENGTH_SHORT).show();

                        // Redirect based on role
                        if ("farmer".equals(userRole)) {
                            startActivity(new Intent(UserLoginActivity.this, FarmerDashboard.class));
                        } else if ("buyer".equals(userRole)) {
                            startActivity(new Intent(UserLoginActivity.this, UserDashboard.class));
                        }
                        finish();
                    })
                    .addOnFailureListener(e -> Toast.makeText(UserLoginActivity.this, "Failed to save role: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        } else {
